...
/*  Game flags */
#define QUIT      0x00001
#define TESTT     0x00002
#define THINK     0x00004
#define MANUAL    0x00008
#define TIMEOUT   0x00010
#define UCI       0x00020
#define WEAK      0x00020
#define ENDED     0x00040
#define USEHASH   0x00080
#define SOLVE     0x00100
#define USENULL   0x00200
#define XBOARD    0x00400
#define TIMECTL   0x00800
#define POST      0x01000
#define PONDER    0x02000 /* We are in pondering (during search) */
#define HARD      0x04000 /* Pondering is turned on */
#define ANALYZE   0x08000 /* In ANALYZE mode */
#define BLINDFOLD 0x10000
